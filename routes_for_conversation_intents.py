...
agreement = Route(
                name="agreement",
                utterances=[
                        "I agree", "Totally agreeing", "That's right",
                        "I concur.",
                        "Absolutely.",
...
disagreement = Route(
                name="disagreement",
                utterances=[
                    "I disagree", "Totally disagreeing", "That's wrong", "I am not sure "
...
requests = Route(
                name="requests",
                utterances=[
                    "I want", "I demand", "I request", "I wish", "I'd like",
                    "Can I have",
                    "Could you please",
                    "I'm asking for",
...
affirmations = Route(
                name="affirmation",
                utterances=[
                    "I state that", "I affirm that", "I strongly believe",
...
other_routes = [affirmations, questions, requests, disagreement, agreement, interruption]
